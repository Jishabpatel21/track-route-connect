...
const Footer: React.FC = () => {
  return (
    <footer className="bg-railway-blue text-white pt-8 pb-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/4 mb-6">
            <h3 className="text-xl font-semibold mb-3">RailConnect</h3>
            <p className="text-sm text-gray-300">
              Your one-stop solution for railway ticket booking, train information, and more.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/4 mb-6">
            ...
            <ul className="list-none">
              ...
              <li className="mb-2">
                <Link to="/pnr" className="text-sm text-gray-300 hover:text-white">
                  PNR Status
                </Link>
              </li>
              <li className="mb-2">
          ...
          <div className="w-full md:w-1/4 mb-6">
            ...
            <ul className="list-none">
              <li className="mb-2">
                <Link to="/contact-us" className="text-sm text-gray-300 hover:text-white">
                  Contact Us
                </Link>
              </li>
              <li className="mb-2">
        ...
        <div className="border-t border-gray-700 mt-6 pt-6">
          <p className="text-sm text-center text-gray-300">
            © {new Date().getFullYear()} RailConnect. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
